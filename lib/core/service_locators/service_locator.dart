...
import 'package:shop_app_clean_architecture/core/cache/base_local_storage_consumer.dart';
import 'package:shop_app_clean_architecture/core/cache/secure_storage_consumer.dart';
...
init() async{
 // repository
  ...
  // datasource
  sl.registerLazySingleton<BaseShopRemoteDS>(() => ShopRemoteDataSourceImplementation(apiConsumer: sl()));
